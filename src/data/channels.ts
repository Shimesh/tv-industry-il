...
export const channels: Channel[] = [
  ...
  { id: 'gold', name: 'ספורט 5 GOLD', number: 57, logo: '/channel-logos/sport-5.png', category: 'sport', color: '#ca8a04', group: 'ספורט' },
  { id: 'live', name: 'ספורט 5 LIVE', number: 58, logo: '/channel-logos/sport-5.png', category: 'sport', color: '#e11d48', group: 'ספורט' },
  { id: 'charlton1', name: "צ'רלטון 1", number: 51, logo: '/channel-logos/charlton-sport-1-4.png', category: 'sport', color: '#2563eb', group: 'ספורט' },
  { id: 'charlton2', name: "צ'רלטון 2", number: 52, logo: '/channel-logos/charlton-sport-1-4.png', category: 'sport', color: '#4f46e5', group: 'ספורט' },
  { id: 'charlton3', name: "צ'רלטון 3", number: 53, logo: '/channel-logos/charlton-sport-1-4.png', category: 'sport', color: '#6d28d9', group: 'ספורט' },
  { id: 'charlton4', name: "צ'רלטון 4", number: 54, logo: '/channel-logos/charlton-sport-1-4.png', category: 'sport', color: '#7e22ce', group: 'ספורט' },
...
const channelNameAliases: Array<{ channelId: string; aliases: string[] }> = [
  ...
  { channelId: 'sport56', aliases: ['ספורט 5+', 'ספורט 5 פלוס', '5 פלוס', '56'] },
  { channelId: 'sport55', aliases: ['ספורט 5', 'ערוץ הספורט', '55'] },
  { channelId: 'charlton1', aliases: ['צ׳רלטון 1', "צ'רלטון 1", 'ספורט 1', 'sport 1', '51'] },
  { channelId: 'charlton2', aliases: ['צ׳רלטון 2', "צ'רלטון 2", 'ספורט 2', 'sport 2', '52'] },
  { channelId: 'charlton3', aliases: ['צ׳רלטון 3', "צ'רלטון 3", 'ספורט 3', 'sport 3', '53'] },
  { channelId: 'charlton4', aliases: ['צ׳רלטון 4', "צ'רלטון 4", 'ספורט 4', 'sport 4', '54'] },
