...
export const columnMappings: Record<string, string> = {
  ...
  'עוזר/ת במאי': 'crew_עוזר במאי',
  'במאי/ת': 'crew_במאי',
  'מפיק/ה': 'crew_מפיק',
  'שיבוץ/כח אדם': 'crew_שיבוץ',
  'ארט דירקטור': 'crew_ארט',
  'מעצב/ת תפאורה': 'crew_תפאורן',
  'אביזרים': 'crew_אביזרים',
  'מאפר/ת': 'crew_איפור',
  'מעצב/ת שיער': 'crew_שיער',
  'מלביש/ה': 'crew_הלבשה',
  'גרפיקה': 'crew_גרפיקה',
...
export const roleDepartmentMap: Record<string, string> = {
  ...
  'גרפיקה': 'טכני',
  'שיבוץ/כח אדם': 'מבצעים',
  'ארט דירקטור': 'ארט ותפאורה',
  'מעצב/ת תפאורה': 'ארט ותפאורה',
  'אביזרים': 'ארט ותפאורה',
  'מאפר/ת': 'ביוטי',
  'מעצב/ת שיער': 'ביוטי',
  'מלביש/ה': 'ביוטי',
