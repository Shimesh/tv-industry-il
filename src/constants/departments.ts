...
const ROLE_ALIAS_KEYS: Record<string, string> = {
  ...
  [roleKey('צלם סטדי')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('צלמת סטדי')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('מפעיל סטדי')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('מפעילת סטדי')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('סטדיקאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('צלם סטדיקאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('צלמת סטדיקאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('מפעיל סטדיקאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('מפעילת סטדיקאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('סטדי קאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('צלם סטדי קאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('צלמת סטדי קאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('מפעיל סטדי קאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('מפעילת סטדי קאם')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('steadicam')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('steadycam')]: 'מפעיל/ת סטדי(קאם)',
  [roleKey('steady cam')]: 'מפעיל/ת סטדי(קאם)',
